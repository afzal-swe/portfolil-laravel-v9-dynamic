                        ...
                        <div class="p-4">
                            <form method="POST" action="{{ route('store.multi.image') }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="multi_image" name="multi_image[]" class="form-control" type="file" multiple=''>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mt-3 pt-1">
                                    <div class="col-12">
                                        <button class="btn btn-primary waves-effect waves-light" type="submit">Add Multi Image</button>
                                    </div>
                                </div>
