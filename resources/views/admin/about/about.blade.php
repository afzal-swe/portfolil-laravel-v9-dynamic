                        ...
                        <div class="p-4">
                            <form method="POST" action="{{ route('update.about',$About->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="title" name="title" class="form-control" type="text" value="{{ $About->title }}">
                                    </div>
                                </div>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="short_title" name="short_title" class="form-control" type="text" value="{{ $About->short_title }}">
                                    </div>
                                </div>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="short_Description" name="short_Description" required class="form-control" rows="5">{{ $About->short_Description }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="elm1" name="logn_Description">{{ $About->logn_Description }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($About->about_image)) ? 
