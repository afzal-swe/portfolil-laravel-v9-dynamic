                        ...
                        <div class="p-4">
                            <form method="POST" action="{{ route('blog.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="blog_title" name="blog_title" class="form-control" type="text" placeholder="Blog Title" value="{{old('blog_title')}}">
                                    </div>
                                </div>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="blog_tags" name="blog_tags" class="form-control" type="text" data-role="tagsinput">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mt-3 pt-1">
                                    <div class="col-12">
                                        <button class="btn btn-primary waves-effect waves-light" type="submit">Create Blog</button>
                                    </div>
                                </div>
