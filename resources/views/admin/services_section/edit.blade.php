                        ...
                        <div class="p-4">
                            <form method="POST" action="{{ route('services.update',$edit->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="short_description" name="short_description" required class="form-control" rows="5" >{{ $edit->short_description }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4 row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="elm1" name="logn_description">{{ $edit->logn_description }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($edit->image)) ? 
                                            url('image/services/'.$edit->image):url('image/No_Image_Available.jpg') }}" alt="Card image cap">
                                    </div>
                                </div>
