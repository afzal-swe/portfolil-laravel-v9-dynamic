                        ...
                        <div class="p-3">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input id="username" name="username" class="form-control" type="text"  placeholder="Username" required autofocus autocomplete="username">
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-0 row mt-2">
                                    <div class="col-sm-7 mt-3">
                                        <a href="{{ route('password.email') }}" class="text-muted"><i class="mdi mdi-lock"></i> Forgot your password?</a>
                                    </div>
