                        ...
                        <div class="portfolio__active">
                            ...
                            <div class="portfolio__item">
                                <div class="portfolio__thumb">
                                    <img src="{{ asset($row->portfolio_image) }}" alt="">
                                </div>
                                <div class="portfolio__overlay__content">
                                    <span>{{ $row->portfolio_name }}</span>
                                    <h4 class="title"><a href="portfolio-details.html">{{ $row->portfolio_title }}</a></h4>
                                    <a href="{{ route('portfolio.details',$row->id) }}" class="link">Case Study</a>
                                </div>
                            </div>
                            @endforeach
                        </div>
