                ...
                <div class="col-lg-8">
                    ...
                    <div class="standard__blog__post">
                        <div class="standard__blog__thumb">
                            <a href="{{ route('blog.details',$post->id)}}"><img src="{{ asset($post->blog_image) }}" alt=""></a>
                            <a href="{{ route('blog.details',$post->id)}}" class="blog__link"><i class="far fa-long-arrow-right"></i></a>
                        </div>
                        <div class="standard__blog__content">
                            <div class="blog__post__avatar">
                                <div class="thumb"><img src="{{ asset(Auth::user()->image) }}" alt=""></div>
                                <span class="post__by">By : <a href="#">{{ Auth::user()->name }}</a></span>
                            </div>
                            <h2 class="title"><a href="{{ route('blog.details',$post->id)}}">{{ $post->blog_title }}</a></h2>
                    ...
                    <aside class="blog__sidebar">
                        ...
                        <div class="widget">
                            ...
                            <ul class="sidebar__tags">
                                ...
                                @foreach ($tags as $all)
                                <li><a href="blog.html">{{ $all->blog_tags }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </aside>
