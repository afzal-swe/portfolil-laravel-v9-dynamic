                        ...
                        <nav class="menu__nav">
                            ...
                            <div class="navbar__wrap main__menu d-none d-xl-flex">
                                <ul class="navigation">
                                    ...
                                    <li class="{{ ($route == 'portfolio.home') ? 'active': " "}}"><a href="{{ route('portfolio.home') }}">Portfolio</a></li>

                                    <li class="{{ ($route == 'home.blog') ? 'active': " "}}"><a href="{{ route('home.blog') }}">Our Blog</a></li>
                                    
                                    <li class="{{ ($route == 'contact.create') ? 'active': " "}}"><a href="{{ route('contact.create') }}">contact me</a></li>
                                </ul>
                            </div>
